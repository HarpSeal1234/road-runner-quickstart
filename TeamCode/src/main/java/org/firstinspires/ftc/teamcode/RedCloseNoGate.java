...
import static org.firstinspires.ftc.teamcode.AutoLocations.RED_CLOSE_FIRST_SHOOT_POS;
import static org.firstinspires.ftc.teamcode.AutoLocations.RED_CLOSE_INITIAL_ANGLE;
import static org.firstinspires.ftc.teamcode.AutoLocations.RED_CLOSE_LEAVE;
import static org.firstinspires.ftc.teamcode.AutoLocations.RED_CLOSE_SPIKE_ONE_END;
import static org.firstinspires.ftc.teamcode.AutoLocations.RED_CLOSE_SPIKE_ONE_SHOOT_POS;
import static org.firstinspires.ftc.teamcode.AutoLocations.RED_CLOSE_SPIKE_ONE_START;
import static org.firstinspires.ftc.teamcode.AutoLocations.RED_CLOSE_SPIKE_TWO_END;
import static org.firstinspires.ftc.teamcode.AutoLocations.RED_CLOSE_SPIKE_TWO_SHOOT_POS;
import static org.firstinspires.ftc.teamcode.AutoLocations.RED_CLOSE_SPIKE_TWO_START;
...
@Config
@Autonomous(name = "Red Close 0X", group = "Autonomous")

public class RedCloseNoGate extends LinearOpMode{
    ...
    public void runOpMode() {
        Pose2d initialPose = new Pose2d(0, 0, Math.toRadians(RED_CLOSE_INITIAL_ANGLE));
        ...
        TrajectoryActionBuilder path1 = drive.actionBuilder(initialPose)
                .setTangent(0.0)
//                .lineToX(-24)
                .splineToConstantHeading(RED_CLOSE_FIRST_SHOOT_POS, 0)
        ...
        TrajectoryActionBuilder spike1 = path1.endTrajectory()
                .fresh()
//                .splineTo(BLUE_CLOSE_SPIKE_ONE_START, Math.toRadians(120))
                .splineToLinearHeading(new Pose2d(RED_CLOSE_SPIKE_ONE_START,Math.toRadians(-90)),0)
                .waitSeconds(fTrajectoryWait)
                .lineToY(RED_CLOSE_SPIKE_ONE_END, new TranslationalVelConstraint(SLOWER_INTAKE_MIN_SPEED))
                .waitSeconds(fTrajectoryWait);
        ...
        TrajectoryActionBuilder toShooter1 = spike1.endTrajectory()
                .fresh()
                .splineToLinearHeading(RED_CLOSE_SPIKE_ONE_SHOOT_POS, 0, new TranslationalVelConstraint(FAST_SPLINE_MIN_SPEED)) // like a z facing towards 90
                .waitSeconds(fTrajectoryWait);
...
//                        intake1.intakeOff(),
        ...
        TrajectoryActionBuilder spike2 = toShooter1.endTrajectory()
                .fresh()
                .splineToLinearHeading(new Pose2d(RED_CLOSE_SPIKE_TWO_START,Math.toRadians(-90)), 0,new TranslationalVelConstraint(FAST_SPLINE_MIN_SPEED))
                .waitSeconds(fTrajectoryWait)
                .lineToY(RED_CLOSE_SPIKE_TWO_END, new TranslationalVelConstraint(SLOWER_INTAKE_MIN_SPEED))
                .waitSeconds(fTrajectoryWait);
        Action Spike2 = spike2.build();
/*
        TrajectoryActionBuilder openGate = spike2.endTrajectory()
                .fresh()
//                .splineToLinearHeading(new Pose2d(BLUE_CLOSE_OPEN_GATE_START,Math.toRadians(90)),0)
...
/*
        // TRAVEL BACK TO SHOOTER
        TrajectoryActionBuilder toShooter2 = openGate.endTrajectory()
                .fresh()
 ...
 */
        ...
        TrajectoryActionBuilder toShooter2 = spike2.endTrajectory()
                .fresh()
                .splineToLinearHeading(RED_CLOSE_SPIKE_TWO_SHOOT_POS, 0, new TranslationalVelConstraint(FAST_SPLINE_MIN_SPEED))
                .waitSeconds(fTrajectoryWait);
        Action ToShooter2 = toShooter2.build();
        ...
        TrajectoryActionBuilder leave = toShooter2.endTrajectory()
                .fresh()
                .splineToLinearHeading(new Pose2d(RED_CLOSE_LEAVE,Math.toRadians(0)),0,new TranslationalVelConstraint(FAST_SPLINE_MIN_SPEED+10))
                .waitSeconds(fTrajectoryWait);
        ...
        Actions.runBlocking(
                new SequentialAction(
                        outtake1.startLauncher(CLOSE_OUTTAKE_VELOCITY+15),
                        intake1.intakeOn(),
                        Spike2,
                        intake1.intakeOff(),
                        new SleepAction(0.05),
