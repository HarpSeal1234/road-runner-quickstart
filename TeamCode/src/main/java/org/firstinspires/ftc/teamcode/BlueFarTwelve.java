...
public class BlueFarTwelve extends LinearOpMode {
...
//        telemetry.addData("April Tag Id", aprilTagId);
        ...
        TrajectoryActionBuilder path2 = path1.endTrajectory()
                .fresh()
                .setTangent(0.0)
                .splineToLinearHeading(new Pose2d(new Vector2d(27, 14), Math.toRadians(90)), Math.toRadians(0.0))
                .waitSeconds(trajectoryWait)
        ...
        TrajectoryActionBuilder toShooterP1 = path2.endTrajectory()
                .fresh()
                .splineToLinearHeading(new Pose2d(new Vector2d(9, 1), Math.toRadians(23)), Math.toRadians(0.0))
                .waitSeconds(trajectoryWait);
        ...
        TrajectoryActionBuilder toShooterP2 = path3.endTrajectory()
                .fresh()
                .splineToLinearHeading(new Pose2d(new Vector2d(9.5, 1), Math.toRadians(25)), Math.toRadians(0.0))
                .waitSeconds(trajectoryWait);
        ...
        TrajectoryActionBuilder path4 = toShooterP2.endTrajectory()
                .fresh()
                .setTangent(0.0)
                .splineToLinearHeading(new Pose2d(new Vector2d(3.5, 24), Math.toRadians(95)), Math.toRadians(0.0))
                .waitSeconds(trajectoryWait+0.2)
        ...
        TrajectoryActionBuilder toShooterP3 = path4.endTrajectory()
                .fresh()
                .splineToLinearHeading(new Pose2d(new Vector2d(9.5, 1), Math.toRadians(25)), Math.toRadians(0.0))
                .waitSeconds(trajectoryWait);
        Action toShooterA3 = toShooterP3.build();

        TrajectoryActionBuilder leavePath = toShooterP3.endTrajectory()
                .fresh()
