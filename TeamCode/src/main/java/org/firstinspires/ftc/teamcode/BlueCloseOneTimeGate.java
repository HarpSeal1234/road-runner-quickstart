...
import static org.firstinspires.ftc.teamcode.AutoLocations.BLUE_CLOSE_OPEN_GATE_END;
...
@Config
@Autonomous(name = "Blue Close 1X", group = "Autonomous")

public class BlueCloseOneTimeGate extends LinearOpMode{
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder path1 = drive.actionBuilder(initialPose)
                .setTangent(0.0)
//                .lineToX(-24)
                .splineToConstantHeading(BLUE_CLOSE_FIRST_SHOOT_POS, 0)
...
//                        intake1.intakeOff(),
        ...
        TrajectoryActionBuilder spike2 = toShooter1.endTrajectory()
                .fresh()
                .splineToLinearHeading(new Pose2d(BLUE_CLOSE_SPIKE_TWO_START,Math.toRadians(90)), 0,new TranslationalVelConstraint(FAST_SPLINE_MIN_SPEED))
                .waitSeconds(fTrajectoryWait)
        ...
        TrajectoryActionBuilder openGate = spike2.endTrajectory()
                 ...
                 */
                .splineToConstantHeading(BLUE_CLOSE_OPEN_GATE_END,0)
                .waitSeconds(fTrajectoryWait);
