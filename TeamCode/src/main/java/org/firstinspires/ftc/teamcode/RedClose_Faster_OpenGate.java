...
@Config
@Autonomous(name = "Red Close Fast OPENGATE", group = "Autonomous")

public class RedClose_Faster_OpenGate extends LinearOpMode{
...
//        telemetry.addData("number of balls", ballNumber);
        ...
        TrajectoryActionBuilder openGate = path3.endTrajectory()
                ...
                .waitSeconds(fTrajectoryWait)
                .strafeToConstantHeading(new Vector2d(-45,-4),new TranslationalVelConstraint(16))
        ...
        TrajectoryActionBuilder toShooter2 = path4.endTrajectory()
                .fresh()
                .splineToLinearHeading(new Pose2d(new Vector2d(-24, 35),Math.toRadians(-58)), 0, new TranslationalVelConstraint(BLUE_CLOSE_FASTER_SPLINE_VELOCITY))
                .waitSeconds(fTrajectoryWait);
