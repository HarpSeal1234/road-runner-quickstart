...
@Config
@Autonomous(name = "new Blue Close Fast", group = "Autonomous")

public class NoCameraBlueClose_Faster extends LinearOpMode{
...
//                .splineTo(BLUE_CLOSE_SPIKE_ONE_START, Math.toRadians(120))
        ...
        TrajectoryActionBuilder toShooter = path3.endTrajectory()
                .fresh()
                .splineToLinearHeading(new Pose2d(new Vector2d(-24, shootYpos+4),Math.toRadians(50)), 0, new TranslationalVelConstraint(BLUE_CLOSE_FASTER_SPLINE_VELOCITY)) // like a z facing towards 90
                .waitSeconds(fTrajectoryWait);
        ...
        TrajectoryActionBuilder toShooter2 = path4.endTrajectory()
                .fresh()
                .splineToLinearHeading(new Pose2d(new Vector2d(-24, shootYpos),Math.toRadians(55)), 0, new TranslationalVelConstraint(BLUE_CLOSE_FASTER_SPLINE_VELOCITY))
                .waitSeconds(fTrajectoryWait);
