...
public class AutoLocations {
    public static final double BLUE_CLOSE_SPIKE_ONE_FINAL_Y = -3;
    public static final double BLUE_CLOSE_SPIKE_TWO_FINAL_Y = -5;
    public static final double BLUE_CLOSE_SPIKE_ONE_MIN_VELOCITY = 16;
    public static final double BLUE_CLOSE_SPIKE_TWO_MIN_VELOCITY = 15;
