...
@Config
@Autonomous(name = "new Blue Close Open Gate 1X 3 Spike", group = "Autonomous")

public class NoCameraBlueClose_OpenGateONCE_THREESpikes extends LinearOpMode{
...
//        Pivot pivot = new Pivot(hardwareMap);
        ...
        TrajectoryActionBuilder path1 = drive.actionBuilder(initialPose)
                .setTangent(0.0)
                .splineToConstantHeading(new Vector2d(-24, -32), 0)
...
//                .splineTo(BLUE_CLOSE_SPIKE_ONE_START, Math.toRadians(120))
                .splineToLinearHeading(new Pose2d(new Vector2d(-29.0, -15),Math.toRadians(120)),0)
                .waitSeconds(fTrajectoryWait)
                .lineToY(-3, new TranslationalVelConstraint(BLUE_CLOSE_SPIKE_ONE_MIN_VELOCITY))
                .waitSeconds(fTrajectoryWait);
        Action trajectoryActionChosen3 = path3.build();

        TrajectoryActionBuilder openGate = path3.endTrajectory()
                .fresh()
        ...
        TrajectoryActionBuilder toShooter = openGate.endTrajectory()
                .fresh()
                .splineToLinearHeading(new Pose2d(new Vector2d(-23.5, -31),Math.toRadians(50)), 0, new TranslationalVelConstraint(BLUE_CLOSE_FASTER_SPLINE_VELOCITY)) // like a z facing towards 90
                .waitSeconds(fTrajectoryWait);
        ...
        TrajectoryActionBuilder path4 = toShooter.endTrajectory()
                .fresh()
                .splineToLinearHeading(new Pose2d(new Vector2d(-49, -22),Math.toRadians(114)), 0,new TranslationalVelConstraint(70))
                .waitSeconds(fTrajectoryWait)
                .lineToY(-2, new TranslationalVelConstraint(BLUE_CLOSE_SPIKE_TWO_MIN_VELOCITY))
                .waitSeconds(fTrajectoryWait);
        ...
        TrajectoryActionBuilder toShooter2 = path4.endTrajectory()
                .fresh()
                .splineToLinearHeading(new Pose2d(new Vector2d(-23.5, -35),Math.toRadians(55)), 0, new TranslationalVelConstraint(75))
                .waitSeconds(fTrajectoryWait);
        Action trajectoryActionToShooterR2 = toShooter2.build();

        TrajectoryActionBuilder path5 = toShooter2.endTrajectory()
                .fresh()
                .splineToLinearHeading(new Pose2d(new Vector2d(-73.5, -22),Math.toRadians(114)), 0,new TranslationalVelConstraint(70))
                .waitSeconds(fTrajectoryWait)
                .lineToY(-3, new TranslationalVelConstraint(BLUE_CLOSE_SPIKE_TWO_MIN_VELOCITY))
                .waitSeconds(fTrajectoryWait);
        Action trajectoryActionChosen5 = path5.build();

        // TRAVEL BACK TO SHOOTER
        TrajectoryActionBuilder toShooter3 = path5.endTrajectory()
                .fresh()
                .splineToLinearHeading(new Pose2d(new Vector2d(-23.5, -33),Math.toRadians(55)), 0, new TranslationalVelConstraint(75))
                .waitSeconds(fTrajectoryWait);
        Action trajectoryActionToShooterR3 = toShooter3.build();

        // LEAVE
        TrajectoryActionBuilder leavePath = toShooter3.endTrajectory()
                .fresh()
                .splineToLinearHeading(new Pose2d(new Vector2d(-27, -5),Math.toRadians(0)),0,new TranslationalVelConstraint(75))
//                .splineToConstantHeading(BLUE_CLOSE_LEAVE,0.0,new TranslationalVelConstraint(BLUE_CLOSE_FASTER_SPLINE_VELOCITY+10))
        ...
        TrajectoryActionBuilder leavePath1 = path5.endTrajectory()
                .fresh()
                .splineToLinearHeading(new Pose2d(new Vector2d(-27, -5),Math.toRadians(0)),0,new TranslationalVelConstraint(75))
//                .splineToConstantHeading(BLUE_CLOSE_LEAVE,0.0,new TranslationalVelConstraint(BLUE_CLOSE_FASTER_SPLINE_VELOCITY+10))
                .waitSeconds(fTrajectoryWait);
        Action leave1 = leavePath1.build();
        ...
        Actions.runBlocking(
                new SequentialAction(
                        ...
                        new SleepAction(0.1),
                        outtake1.startLauncher(CLOSE_OUTTAKE_VELOCITY+40),
                        intake1.intakeOff(),
                        openGateAction,
